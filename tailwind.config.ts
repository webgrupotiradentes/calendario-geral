  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        administrative: {
          DEFAULT: "hsl(var(--administrative))",
          foreground: "hsl(var(--administrative-foreground))",
        },
        holiday: {
      ...
      boxShadow: {
        'apple-sm': '0 1px 2px 0 rgb(0 0 0 / 0.03)',
        'apple': '0 4px 6px -1px rgb(0 0 0 / 0.05), 0 2px 4px -2px rgb(0 0 0 / 0.05)',
        'apple-md': '0 10px 15px -3px rgb(0 0 0 / 0.08), 0 4px 6px -4px rgb(0 0 0 / 0.05)',
        'apple-lg': '0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.08)',
